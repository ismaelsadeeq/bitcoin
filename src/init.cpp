...
void SetupServerArgs(ArgsManager& argsman, bool can_listen_ipc)
{
    ...
    argsman.AddArg("-sharetemplatebacklog", strprintf("Number of block templates to store and share to peers (default: %d). Set to 0 to disable sharing block templates.", DEFAULT_SHARETMPL_COUNT), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::NODE_RELAY);
