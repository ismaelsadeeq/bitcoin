...
static BlockAssembler::Options ClampOptions(BlockAssembler::Options options)
{
    ...
    options.nBlockMaxWeight = std::clamp<size_t>(options.nBlockMaxWeight, options.block_reserved_weight, DEFAULT_BLOCK_MAX_WEIGHT);
    return options;
}
...
void BlockAssembler::resetBlock()
{
    ...
    // Reserve space for coinbase tx and block header
