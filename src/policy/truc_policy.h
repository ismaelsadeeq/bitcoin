...
// TRUC only allows 1 parent and 1 child when unconfirmed.
 ...
 * - if a TRUC transaction T has a parent in the mempool and a child in the package, then PackageTrucChecks(T) will fail
 * - if a TRUC transaction T has a parent in the package and a child in the package, then PackageTrucChecks(T) will fail
