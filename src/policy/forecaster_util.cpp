    ...
    const std::vector<std::tuple<CFeeRate, uint32_t>>& fee_rate_stats)
{
    ...
    const auto p5_weight{static_cast<unsigned int>(0.05 * DEFAULT_BLOCK_MAX_WEIGHT)};
    const auto p25_weight{static_cast<unsigned int>(0.25 * DEFAULT_BLOCK_MAX_WEIGHT)};
    const auto p50_weight{static_cast<unsigned int>(0.5 * DEFAULT_BLOCK_MAX_WEIGHT)};
    const auto p75_weight{static_cast<unsigned int>(0.75 * DEFAULT_BLOCK_MAX_WEIGHT)};
