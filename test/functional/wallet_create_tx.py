...
class CreateTxWalletTest(BitcoinTestFramework):
    ...
    def test_version3(self):
        ...
        wallet_version3 = self.nodes[0].get_wallet_rpc("version3")

        tx_data = wallet_rpc.send(outputs=[{wallet_version3.getnewaddress(): 25}], options={"change_position": 0})
