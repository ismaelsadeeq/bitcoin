...
class MiningTest(BitcoinTestFramework):
    ...
    def test_block_max_weight(self):
        ...
        self.log.info("Test that node will fail to start when user provide consensus invalid -blockreservedweight")
        self.stop_node(0)
        ...
        self.nodes[0].assert_start_raises_init_error(
            ...
            expected_msg=f"Error: Specified -blockreservedweight ({MINIMUM_BLOCK_RESERVED_WEIGHT - 1}) is lower than minimum sane value of ({MINIMUM_BLOCK_RESERVED_WEIGHT})",
        )
